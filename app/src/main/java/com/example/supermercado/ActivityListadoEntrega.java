...
public class ActivityListadoEntrega extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listado_entrega);
        lista=(ListView) findViewById(R.id.lista800);
        ...
        lista.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent=new Intent(getApplicationContext(), Activity_detalle_pedido_repartidor.class);
                ...
                intent.putExtra("telefono",facturalista.get(i).getTelefono());
                intent.putExtra("longitud",facturalista.get(i).getLongitud());
                intent.putExtra("latitud",facturalista.get(i).getLatitud());
    ...
    private void ObtenerLista() {
        StringRequest stringRequest=new StringRequest(Request.Method.GET, "http://apk.salasar.xyz:25565/factura_repartidor.php?codigo=0123456789", new Response.Listener<String>(){
            @Override
    ...
    public void atras2030(View view){
