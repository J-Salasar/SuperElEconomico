...
public class ActivityCrearProducto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nombre=(EditText) findViewById(R.id.nombre98);
        precio=(EditText) findViewById(R.id.precio98);
        sumar=(Button) findViewById(R.id.sumar98);
        restar=(Button) findViewById(R.id.restar98);
        cantidad_cliente=(EditText) findViewById(R.id.cliente_cantidad98);
        foto=(ImageView) findViewById(R.id.foto98);
    ...
    public void verificarcrear(View view){
    ...
    public void crear_producto(){
        StringRequest stringRequest=new StringRequest(Request.Method.POST, "http://apk.salasar.xyz:25565/crear_producto.php", new Response.Listener<String>(){
            @Override
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                parametros.put("cantidad", cantidad_cliente.getText().toString());
                return parametros;
            }
        };
    ...
    public void permisos_camara98(View view) {
