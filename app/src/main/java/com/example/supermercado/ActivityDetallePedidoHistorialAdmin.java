...
public class ActivityDetallePedidoHistorialAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detalle_pedido_historial_admin);
        id=(TextView) findViewById(R.id.factura_numero500);
        nombre=(TextView) findViewById(R.id.cliente_factura500);
        fecha=(TextView) findViewById(R.id.fecha_factura500);
        hora=(TextView) findViewById(R.id.hora_factura500);
        total=(TextView) findViewById(R.id.total_factura500);
        ...
        lista=(ListView)findViewById(R.id.lista_factura2022500);
        ObtenerLista();
    }
    ...
    public void retroceder2022500(View view){
